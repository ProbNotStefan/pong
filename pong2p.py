...
def pong2p():
    ...
    # game loop
    paddle1 = playerpaddle(50,screen_y)
    paddle2 = playerpaddle(screen_x-50,screen_y)
    ...
    while running:
        ...
        paddle1.handleevents(keys[K_w],keys[K_s])
        paddle2.handleevents(keys[K_UP],keys[K_DOWN])
